package com.valdemare.recipe.bootstrap;

import com.valdemare.recipe.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        log.debug("inside onEvent method");
    }
/*
    private List<Recipe> getRecipes(){
        ...
        Optional<UnitOfMeasure> tabSpoonUomOptional = unitOfMeasureRepository.findByDescription("Tablespoon");
        if (!tabSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM not found!");
        }
        ...
        UnitOfMeasure tableSpoonUom = tabSpoonUomOptional.get();
        ...
        guacRecipe.setDescription("Some weird food");
        guacRecipe.setPrepTime(10);
        guacRecipe.setCookTime(0);
        guacRecipe.setDifficulty(Difficulty.EASY);
        guacRecipe.setDirections("Prosto zabey");

        Notes guacNotes = new Notes();
        guacNotes.setRecipeNotes("Nu zabey uzhe nakonets!");

        guacRecipe.setNotes(guacNotes);

        guacRecipe.getIngredients().add(new Ingredient("ripe acocados", new BigDecimal(2), eachUom));
        guacRecipe.getIngredients().add(new Ingredient("kosher salt", new BigDecimal(5), teaSpoonUom));
        guacRecipe.getIngredients().add(new Ingredient("pork", new BigDecimal(25), tableSpoonUom));
        ...
        tacoRecipe.setDescription("Taco recipe");
        tacoRecipe.setPrepTime(15);
        tacoRecipe.setCookTime(2);
        tacoRecipe.setDifficulty(Difficulty.MODERATE);
        tacoRecipe.setDirections("bla-bla-bla");

        Notes tacoNotes = new Notes();
        tacoNotes.setRecipeNotes("Tak-tak, 4to tut u nas?");

        tacoRecipe.setNotes(guaNotes);

        tacoRecipe.getIngredients().add(new Ingredient("chicken", new BigDecimal(1), pintUom));
        tacoRecipe.getIngredients().add(new Ingredient("sauce", new BigDecimal(5), teaSpoonUom));
        tacoRecipe.getIngredients().add(new Ingredient("onion", new BigDecimal(15), tableSpoonUom));
